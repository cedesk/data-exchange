...
public class ViewTreeNodeFactory {
    ...
    private final static Image SYS_ICON = new Image("/resources/spacecraft.png");

    private final static Image SUBSYS_ICON = new Image("/resources/subsystem.png");

    private final static Image ELEMENT_ICON = new Image("/resources/element.png");
