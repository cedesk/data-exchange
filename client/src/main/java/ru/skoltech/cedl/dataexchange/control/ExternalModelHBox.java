...
/**
 * Control for display external model.
 *
 * Created by D.Knoll on 24.09.2015.
 */
public class ExternalModelHBox extends HBox implements Initializable {

    private static final Logger logger = Logger.getLogger(ExternalModelHBox.class);
    ...
    private ExternalModelHBox() {
    }

    public ExternalModelHBox(ExternalModel externalModel) {
