 ...
 */
public class ImportTradespaceFromExcelDemo extends AbstractApplicationContextDemo {

    @Override
    public void demo(Stage primaryStage) {
        GuiService guiService = context.getBean(GuiService.class);
        ViewBuilder viewBuilder = guiService.createViewBuilder("Import Excel into the Tradespace", Views.IMPORT_TRADESPACE_FROM_EXCEL_VIEW);
